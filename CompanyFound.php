...
<?php
	...
	echo "<tr><td>Click the Button Below to View More Information on the Company's Page<br><a href=''><img align=center src='images/ToPage.jpg' style='width:15%;height:15%;' alt='To Next Page'/></a></td></tr>";
	echo '</table>';
?>
<br>
<div class='select'>
