...
<h1>The Company <?php echo $_GET['comp'];?> Was Found</h1>
<div class='txt'>
...
<?php
	...
	echo '<table align=center width="250%" height="250%">';
	echo '<tr><td><h3>' . $CompanyName .'</h3></td></tr>';
	echo '<tr><td>' . $results[0]['CompanyPicture'] . '</td><tr>';
	echo "<tr><td>Click the Button Below to View More Information on the Company's Page<br><a href=""><img align=center src='images/ToPage.jpg' class='TableImg' alt='To Next Page'/></a></td></tr>";
	echo '</table>';
?>
<br>
<div class='select'>
