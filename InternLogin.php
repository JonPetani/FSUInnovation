  ...
  <?php
   ...
   $con ->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    <div class="ftco-blocks-cover-1" style="margin-top: 6%">
        <div class="ftco-cover-1" style="background-image: url('images/pic11.jpg');">
              <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 text-center">
					  <b><h1 style='font-size: 280%; text-shadow: 5px 3px black; margin-top: 160px'><font color='white'>Login:</font></h1></b>
					   <b><h3 style='font-size: 230%; text-shadow: 5px 3px black'><font color='white'>Login in as an Intern</font></h3></b><br/>
