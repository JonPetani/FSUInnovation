...
<html lang="en">
  ...
  <div class="site-wrap" id="home-section" style="margin-left: 10%; margin-right: 5%">
    ...
    <div class="site-section" style="margin-right: 100px">
			<center><a href='index.php'><img src="images/fsu_logo1.png"></img></a></center>
			<br/><br/><h1><b>Results</b></h1><br/>
            <br/><p class="lead">Search Query for <?php echo $_POST['CompanyName'];?> Result:</p>
			
			<br/><p class="lead">To visit a Member's Page to find what kind of work their looking for, click a button to the right side of each row to visit it</p><br/>
			...
			<?php
				...
				echo "<table align='center' width='145%' height='120%' 'border=solid black'>";
				...
				for($i=0; $i<sizeof($results); $i++) {
					...
					echo'<td><a href="CompanyPage.php?comp=' . $Company . '"><img src="images/ToPage.jpg" class="TableImg" alt="To Next Page" height="40%" style="margin-left: 3%; margin-bottom: 10%"/></a></td>';
					echo'</tr>';
					}
				echo"</table>";
			?>
			</div><br/><br/>
			<center><h3>Didn't find what you were looking for?</h3>
			<h3>Is Possible This Company Has Not Set Up A Page Yet?</h3><br/>
				<a href='CompanyFind.php'>Try Another Company or Word(s)</a>
