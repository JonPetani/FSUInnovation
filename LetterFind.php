...
<html lang="en">
  ...
  <div class="site-wrap" id="home-section" style="margin-left: 10%; margin-right: 5%">
    ...
    <div class="site-section" style="margin-right: 100px">
            ...
            <br/><p class="lead">Companies found starting with the letter <?php echo $_GET['by'];?> are:</p>
			...
			<?php
				...
				echo "<table align='center' width='150%' height='120%' border='solid black'>";
				...
				for($i=0; $i<sizeof($results); $i++) {
					...
					echo'<td><a href="CompanyPage.php?comp=' . $Company . '"><img src="images/ToPage.jpg" class="TableImg" alt="To Next Page" height="40%" width="40%"/></a></td>';
					echo'</tr>';
					}
					echo"</table>";
			?>
