...
<html lang="en">
	<head>
		...
		if(isset($_SESSION['loggedin'])) {
			if($_SESSION['loggedin'] == true) {
				...
				if($_SESSION['UserType'] == "Member") {
					...
					echo "<a href='PrivateMessageBoard.php'><img src='images/PM.png' class='accounts' onmouseover='this.src=\"images/PMOpen.png\";' onmouseout='this.src=\"images/PM.png\";'/></a>";
					}
		...
		<br><a href="Home.php"><img id="fsu_logo" src="images/fsu_logo1.png" alt="FSU Logo"/></a>
