...
<html lang="en">
  ...
  <div class="site-wrap" id="home-section" style="margin-left: 10%; margin-right: 5%">
    ...
    <div class="site-section" style="margin-right: 100px">
			<center><a href='index.php'><img src="images/fsu_logo1.png" style='height: 150px; width: 350px'></img></a>
			<br/><br/><br/><h2>Contact Message was Sent to an Admin</h2>
			<p>Check your inbox frequently to see when one of our Admins replies. They will try to answer any questions to the best of their ability.</p>
			<a href='index.php'>Go to Home Page</a></center>
		</div>
    </div>      
