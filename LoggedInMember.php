...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <center><a href="index.php"><img id="fsu_logo" src="images/fsu_logo1.png" alt="FSU Logo" height='60%' width='60%'/></a><br/><br/>
		...
		<br/><img src="<?php echo $_SESSION['CompanyPicture']?>" width='250' height='250' alt='profile picture'/><br/><br/>
		...
		<br/><h2 align=center>What to do with your account:</h2><br/>
		<a href='RegisterJob.php'>Post a Job</a><br/>
		<a href='AppListMember.php'>View Intern Applications for Projects</a><br/>
		<a href='Projects.php'>View and Manage Projects listed</a><br/>
		<a href='AddKeywords.php'>Create some keywords to make your Company easier to find</a><br/>
		<a href='Nav.php'>View Services Available</a><br/>
